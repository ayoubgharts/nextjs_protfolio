    ...
    <main className={styles.tutorials}>
      <Container>
        ...
        <div style={{ overflowX: "auto", marginTop: "30px" }}>
          <h3>القطع المستخدمة</h3>
          <table style={{ width: "100%", borderCollapse: "collapse", direction: "ltr" }}>
            <thead>
              <tr style={{ borderBottom: "2px solid var(--light)", textAlign: "left" }}>
                <th>Category</th>
                <th>Part</th>
                <th>Notes</th>
              </tr>
            ...
            <tbody>
              <tr>
                ...
                <td>Or Pro Mini. Needs enough UART/soft‑serial for GPS, BP sensor, optional GSR.</td>
              </tr>
              <tr>
                <td>Location</td>
                <td>NEO‑6M GPS module</td>
                <td>
                  Cheap breakout boards available. Requires clear sky view. <br />
                  <a href="https://randomnerdtutorials.com/guide-to-neo-6m-gps-module-with-arduino/?utm_source=chatgpt.com" target="_blank">Random Nerd Tutorials</a>
                </td>
              </tr>
              <tr>
                <td>Heart Rate</td>
                ...
                <td>
                  PulseSensor Playground library. PPG at fingertip/wrist.<br />
                  <a href="https://pulsesensor.com/pages/code-and-guide?utm_source=chatgpt.com" target="_blank">PulseSensor Guide</a>,
                  <a href="https://www.sparkfun.com/pulse-sensor.html?utm_source=chatgpt.com" target="_blank"> SparkFun</a>
                </td>
              </tr>
              <tr>
                <td rowSpan={2}>Blood Pressure</td>
                <td>– Small air pump (e.g. 5 V mini pump)</td>
                <td rowSpan={2}>Range ≈ 0–350 mbar for 0–262 mmHg.<br />
                <a href="https://www.analog-micro.com/products/pressure-sensors/board-mount-pressure-sensors/ams5915/ams5915-an03.pdf?utm_source=chatgpt.com" target="_blank">AMS5915 Datasheet</a></td>
              </tr>
              <tr>
                <td>– Differential pressure sensor AMS 5915</td>
              </tr>
              <tr>
