  ...
  return (
    <main className={styles.tutorials}>
      <Container>
        ...
        <h3 className={styles.h3}>1. قطع الجهاز</h3>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              (<a href="https://pulsesensor.com/pages/code-and-guide?utm_source=chatgpt.com" target="_blank">PulseSensor</a>,
          ...
          <tr>
            ...
            <td>
              – Small air pump (e.g. 5 V mini pump)<br />– Solenoid valve
            </td>
            <td>
              – Differential pressure sensor AMS 5915, Range ≈ 0–350 mbar for 0–262 mmHg.
              (<a href="https://www.analog-micro.com/products/pressure-sensors/board-mount-pressure-sensors/ams5915/ams5915-an03.pdf?utm_source=chatgpt.com" target="_blank">Analog Microelectronics PDF</a>).
            </td>
          </tr>
          <tr>
